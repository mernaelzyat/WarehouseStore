...
namespace WarehouseStores.Repository.Data.Migrations
{
    ...
    [Migration("20240728080252_UpdatePriceInProducts")]
    partial class UpdatePriceInProducts
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("DepartmentsStorage", b =>
                {
                    ...
                    b.HasKey("DepartmentsId", "StoragesId");

                    b.HasIndex("StoragesId");

                    b.ToTable("DepartmentsStorage");
                });
            ...
            modelBuilder.Entity("ProductsPurchaseOrders", b =>
                {
            ...
            modelBuilder.Entity("WarehouseStores.Core.Models.SupplyFromInventoryToSales", b =>
                {
                    b.Property<int?>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
                    ...
                    b.ToTable("SupplyFromInventoryToSales");
                });

            modelBuilder.Entity("WarehouseStores.Core.Models.SupplyFromWarehouses", b =>
                {
                    b.Property<int?>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
                    ...
                    b.ToTable("SupplyFromWarehouses");
                });
            ...
            modelBuilder.Entity("DepartmentsStorage", b =>
                {
                    b.HasOne("WarehouseStores.Core.Models.Departments", null)
                        .WithMany()
            ...
            modelBuilder.Entity("ProductsPurchaseOrders", b =>
                {
                    ...
                    b.HasOne("WarehouseStores.Core.Models.PurchaseOrders", null)
                        .WithMany()
            ...
            modelBuilder.Entity("WarehouseStores.Core.Models.SupplyFromInventoryToSales", b =>
                {
                    ...
                    b.HasOne("WarehouseStores.Core.Models.Products", "Product")
                        .WithMany("SupplyFromInventoryToSales")
                        .HasForeignKey("ProductId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();
            ...
            modelBuilder.Entity("WarehouseStores.Core.Models.SupplyFromWarehouses", b =>
                {
                    ...
                    b.HasOne("WarehouseStores.Core.Models.Employees", "Employee")
                        .WithMany()
            ...
            modelBuilder.Entity("WarehouseStores.Core.Models.Products", b =>
                {
                    ...
                    b.Navigation("SupplyFromInventoryToSales");
                });
